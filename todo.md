...
2. use this knowledge for research and try to implement those in throughspec:
...
11. comments cleanup in this codebase, remove unnecessary comments and add meaningful comments where needed for better code readability and maintainability. Every comment should only be 1 liner and max 15 words long. Remove any commented-out code/dead code which is not commented and never being invoked.
12. Benchmarks in throughspec for research paper as well as for proving how this is better than normal claude or direct competitors of throughspec for Spec Driven Development.
